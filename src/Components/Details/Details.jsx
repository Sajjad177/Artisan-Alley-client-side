...
const Details = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:5000/singleData/${id}`)
            .then(res => res.json())
            .then(data => {
                console.log(data)
                setItemDetails(data)
    ...
    const {itemName, subcategory, customization, stockStatus, photo, time, price, rating, description} = itemsDetails
        ...
        <div>
            ...
            <div className="border border-orange-50 my-10 lg:p-10 p-5 flex lg:flex-row  flex-col lg:gap-20 gap-10 rounded-lg shadow-lg">
                ...
                <div className="space-y-5">
                    ...
                    <div data-aos="fade-left" data-aos-duration="1200" data-aos-delay="1200" className="flex lg:flex-row md:flex-row flex-col lg:gap-20 md:gap-16 lg:items-center">
                        <h2> <span className="font-semibold text-lg">Time :</span> {time}</h2>
                        
                        <h2> <span className="font-semibold text-lg">Rating :</span> {rating}</h2>
                    </div>
                    <div>
